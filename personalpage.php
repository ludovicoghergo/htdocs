		...
		<div class="row">
			...
			<div class="col-md-10 offset-md-1 col-lg-9 offset-lg-0">
				...
				<div class="row">
                  ...
                  <input type="text" class="form-control" id="first-name" value="<?php echo ucfirst($row['fname'])?>">
								</div>
								<!-- Last Name -->
								<div class="form-group">
									<label for="last-name">Last Name</label>
									<input type="text" class="form-control" id="last-name" value="<?php echo ucfirst($row['lname'])?>">
								</div>
								<!--
                File chooser
                 ...
                 <div class="form-group">
 									...
 									<input type="text" class="form-control" id="last-name" value="<?php echo ucfirst($row['email'])?>">
 								</div>
								<!-- Comunity Name -->
								<div class="form-group">
